            ...
            content: [
              {
                ...
                {"name":"string","servingSize":"string","calories":number,"protein":number,"carbs":number,"fat":number,"fiber":number,"sugar":number,"salt":number,"potassium":number,"confidence":"high|medium|low","ingredients":[]}`
              },
              {
                type: 'image_url',
                image_url: {
